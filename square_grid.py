...
class SquareGrid:
    ...
    def update(self):
        ...
        if self.lifeforms:
            ...
            total_neighbors_all = stacked_counts.sum(axis=0)
        ...
        for lifeform in self.lifeforms:
            ...
            # Kill attribution for overcrowding deaths only
            ...
            if self.lifeforms and np.any(death_overcrowd):
                counts_at = stacked_counts[:, death_overcrowd]
                # Ignore self counts when picking killer
